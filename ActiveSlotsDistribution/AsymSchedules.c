...
#define SAFE_REALLOC(var, type, size)                                                                     \
    do                                                                                                    \
    {                                                                                                     \
...
bitmap_t *bitmapNew(unsigned int bitmapLength)
{
    ...
    if (bitmapLength % (8 * sizeof(uint64_t)) != 0)
        bufferSize++;
...
void NDT(bd_t *bd1, bd_t *bd2)
{
    ...
    /*
        Size of schedule one
        Size of schedule two
        GCD between schedule one and two sizes
    ...
    */
    ...
    for (o = 0; o < g; o++)
    {
        ...
        // Num of active common slots
        //printf(" %d", sortedArrayLength(intersections));
